...
const THINGS: { [key: string]: Thing[] } = {
  ...
  'bg/stall': [
    ...
    { x: 0.8, y: 0.65, name: 'ボロ', desc: 'ニーナが持ってくるバゲットがお気に入り' },
    { x: 0.8, y: 0.65, name: 'ボロ', desc: '……こんな顔だっけ？' }
  ],
  'bg/apothecary': [
    { x: 0.55, y: 0.58, name: '薬学書', desc: '「精神安定剤」のページが開かれている\nカスラの実から調合されるらしい' },
    { x: 0.22, y: 0.42, name: '精神安定剤', desc: '売り切れのようだ' },
    { x: 0.165, y: 0.425, name: 'カラフルな薬', desc: '怪しげな色の薬' },
    { x: 0.1, y: 0.43, name: '悪夢予防薬', desc: 'ネムルとニーナが服用している薬' },
    { x: 0.78, y: 0.4, name: '診察室？', desc: '入ったことがない' },
  ],
  'bg/shore': [
    { x: 0.7, y: 0.7, name: 'お姉さんの荷物', desc: '魔法のコンパスが海の向こうを指している' },
    { x: 0.66, y: 0.66, name: 'お姉さんの荷物', desc: '精神安定剤の空きビンが入っている' },
    { x: 0.255, y: 0.16, name: '月', desc: '以前よりも大きく見えるらしい' }
  ],
  'bg/wulfric-home': [
    { x: 0.42, y: 0.25, name: 'カトラス', desc: 'とても大きなカトラス' },
    { x: 0.5, y: 0.35, name: '昔の地図', desc: '大洪水が起きる前の地図\nカオティクスの住む地域の地形は今とは大きく異なる' },
    { x: 0.16, y: 0.4, name: '棚', desc: '食料や酒がある' }
  ]
}
</script>
